                    ...
                    <form action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <!-- Info: Available Subjects -->
                                <div class="mt-3 p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                                    <div class="flex items-start">
                                        <svg class="flex-shrink-0 w-4 h-4 mt-0.5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
                                        </svg>
                                        <div>
                                            <span class="font-medium">Subject Information:</span>
                                            <p class="mt-1">Only showing available subjects and your current subject.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea 
                                    ...
                                    class="block w-full p-2.5 border rounded-lg bg-gray-50 border-gray-300 text-gray-900 text-sm
                                           ...
                                           dark:focus:ring-primary-500 dark:focus:border-primary-500">{{ old('address', $teacher->address) }}</textarea>
                                @error('address')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
